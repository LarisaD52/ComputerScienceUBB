...
public class Interpreter {
    ...
    //============================
        ...
        try {
            ...
            ProgramState prg12 = new ProgramState(new StackExecutionStack<>(), new MapSymbolTable<>(), new ListOut<>(), ex12, new MapFileTable());
            IRepository rep12 = new Repository(prg12, "log12.txt");
            Controller ctr12 = new Controller(rep12, true); // safe GC + threads
            menu.addCommand(new RunExample("12", "Program 12: For statement ", ctr12));
        } catch (MyException e) {
            System.err.println("Program 12 esuat la TypeCheck: " + e.getMessage());
        }
                                                                                                                                                ...
                                                                                                                                                new CompoundStatement(
                                                                                                                                                        ...
                                                                                                                                                        new CompoundStatement(
                                                                                                                                                                ...
                                                                                                                                                                new CompoundStatement(
                                                                                                                                                                        ...
                                                                                                                                                                        new UnlockStatement("q"))))))))))))))))))));
        try {
            ex13.typecheck(new MapSymbolTable<String, IType>());
            ProgramState prg13 =
                    new ProgramState(
            ...
            menu.addCommand(
                    new RunExample("13", "Program 13: Locks", ctr13));
        } catch (MyException e) {
            System.err.println("Program 13 esuat la typecheck: " + e.getMessage());
        }
