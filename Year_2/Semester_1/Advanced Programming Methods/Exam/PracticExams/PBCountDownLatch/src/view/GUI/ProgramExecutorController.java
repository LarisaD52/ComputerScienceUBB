...
public class ProgramExecutorController {
    ...
    public void initialize() {
        ...
        latchLocationColumn.setCellValueFactory(
                p -> new SimpleIntegerProperty(p.getValue().getKey()).asObject()
        );

        latchValueColumn.setCellValueFactory(
                p -> new SimpleIntegerProperty(p.getValue().getValue()).asObject()
        );
    ...
    private void populateLatchTable() {
        ...
        ObservableList<Map.Entry<Integer, Integer>> latchList =
                FXCollections.observableArrayList();

        latchList.addAll(ps.getLatchTable().getContent().entrySet());
        latchTableView.setItems(latchList);
    }
