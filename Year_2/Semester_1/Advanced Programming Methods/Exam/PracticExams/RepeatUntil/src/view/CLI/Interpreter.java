...
public class Interpreter {
    ...
    IStatement ex12 =
                ...
                new CompoundStatement(
                    ...
                    new CompoundStatement(
                        ...
                        new CompoundStatement(
                            ...
                            new CompoundStatement(
                                new AssignmentStatement(
                                    "x", new ConstantExpression(new IntegerValue(1))),
                                new CompoundStatement(
                                    new NoOperationStatement(),
                                    new CompoundStatement(
                                        new AssignmentStatement(
                                            "y", new ConstantExpression(new IntegerValue(3))),
                                        new CompoundStatement(
                                            new NoOperationStatement(),
                                            new PrintStatement(
                                                new BinaryOperatorExpression(
        ...
        try {
            ...
            IRepository rep13 = new Repository(prg13, "log12.txt");
            Controller ctr13 = new Controller(rep13, true);
            menu.addCommand(new RunExample("12",
                    "Program 12: repeat + fork example",
                    ctr13));
        } catch (MyException e) {
            System.err.println("Program 12 Eșuat: " + e.getMessage());
        }
