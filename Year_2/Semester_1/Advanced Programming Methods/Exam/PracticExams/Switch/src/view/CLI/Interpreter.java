...
////Program 12 (SWITCH)
                                                        ...
                                                        new CompoundStatement(
                                                                ...
                                                                new CompoundStatement(
                                                                        new SwitchStatement(
                                                                                ...
                                                                                // case stmt1: print(a); print(b)
                                                                                new CompoundStatement(
                                                                                        new PrintStatement(new VariableExpression("a")),
                                                                                        new PrintStatement(new VariableExpression("b"))
                                                                                ),

                                                                                // case stmt2: print(100); print(200)
                                                                                new CompoundStatement(
        ...
        try {
            ...
            Controller ctr12 = new Controller(rep12);
            menu.addCommand(new RunExample("12", "Program 12: switch(a*10) cases (b*c) / 10 default; final out {1,2,300}", ctr12));
        } catch (MyException e) {
